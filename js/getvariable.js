...
if(Ubicacion > 0){
    ...
    var UrlMain = 'http://181.199.66.129:5060/test/' +Pais+ '/' +Provincia+ '/' +Ciudad+ '/' +Sector + '/' +Ubicacion
    ...
    var UrlMain = 'http://181.199.66.129:5060/test/' +Pais+ '/' +Provincia+ '/' +Ciudad+ '/' +Sector 
    ...
    var UrlMain = 'http://181.199.66.129:5060/test/' +Pais+ '/' +Provincia+ '/' +Ciudad
    ...
    console.log ("URL Riesgos Motivo: " + UrlRiesgo)
        ...
        var UrlMain = 'http://181.199.66.129:5060/test/' +Pais+ '/' +Provincia
        ...
        var UrlMain = 'http://181.199.66.129:5060/test/' +Pais
